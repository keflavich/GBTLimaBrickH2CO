...
for cubename,restfreq,samplers,cunit3,ctype3,naxis3,cdelt3 in (
        ('CMZ_East_H77a_cube',  14.12861587343394e9,  ['D1_3', 'D2_3', 'H2_3',
                                                       'H1_3',], 'km/s',
         'VRAD', 200, 2),
        ('CMZ_East_H78a_cube',  13.595489217126786e9,  ['D1_0', 'D2_0', 'H2_0',
                                                        'H1_0',], 'km/s',
         'VRAD', 200, 2),
        ('CMZ_East_H79a_cube',  13.088851579541037e9,  ['A1_6', 'A2_6', 'E2_6',
                                                        'E1_6',], 'km/s',
         'VRAD', 200, 2),
        ('CMZ_East_H80a_cube',  12.607077993723573e9,  ['A1_4', 'A2_4', 'E2_4',
                                                        'E1_4',], 'km/s',
         'VRAD', 200, 2),
        ('CMZ_East_H81a_cube',  12.148661661622242e9,  ['A1_0', 'A2_0', 'E2_0',
                                                        'E1_0',], 'km/s',
         'VRAD', 200, 2),
        ('CMZ_East_H76a_cube',  14.689985639149523e9,  ['D1_7', 'D2_7', 'H2_0',
                                                        'H1_7',], 'km/s',
         'VRAD', 200, 2),
